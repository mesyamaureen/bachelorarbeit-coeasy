@ModelType CoEasy.MitarbeiterListe
                ...
                <div class="col">
                    ...
                    <div>
                        <table class="table table-striped table-bordered" id="Tabelle">
                            ...
                            @For Each einzMitarbeiter In Model.Mitarbeiter 'hier Model.alle öffentlichen Properties
                                @<tr>
                                    <td>@einzMitarbeiter.BenutzerID</td>
                                    <td>@einzMitarbeiter.Benutzername</td>
                                    <td>@einzMitarbeiter.Vorname</td>
                                    <td>@einzMitarbeiter.Name</td>
                                    <td>
                                        @Html.ActionLink("Öffnen", "Oeffnen", "Mitarbeiter", New With {.ID = einzMitarbeiter.BenutzerID}, New With {.class = "btn btn-info", .role = "button"})
                                    </td>
                                </tr>
                            Next
                        </table>
